...
(0, _ava2.default)('adds classNames to children', function (t) {
  ...
  var className = json[0].props.className;

  t.true(_rec._expr(_rec._capt(_rec._capt(_rec._capt(_rec._capt(_rec._capt(_rec._capt(json, 'arguments/0/left/object/object/object/object')[0], 'arguments/0/left/object/object/object').props, 'arguments/0/left/object/object').className, 'arguments/0/left/object').length, 'arguments/0/left') > 0, 'arguments/0'), {
    content: 't.true(json[0].props.className.length > 0)',
    filepath: 'test.js',
    line: 31,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":">","left":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"json","range":[7,11]},"property":{"type":"NumericLiteral","value":0,"range":[12,13]},"computed":true,"range":[7,14]},"property":{"type":"Identifier","name":"props","range":[15,20]},"computed":false,"range":[7,20]},"property":{"type":"Identifier","name":"className","range":[21,30]},"computed":false,"range":[7,30]},"property":{"type":"Identifier","name":"length","range":[31,37]},"computed":false,"range":[7,37]},"right":{"type":"NumericLiteral","value":0,"range":[40,41]},"range":[7,41]}],"range":[0,42]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"json","range":[7,11]},{"type":{"label":"["},"range":[11,12]},{"type":{"label":"num"},"value":0,"range":[12,13]},{"type":{"label":"]"},"range":[13,14]},{"type":{"label":"."},"range":[14,15]},{"type":{"label":"name"},"value":"props","range":[15,20]},{"type":{"label":"."},"range":[20,21]},{"type":{"label":"name"},"value":"className","range":[21,30]},{"type":{"label":"."},"range":[30,31]},{"type":{"label":"name"},"value":"length","range":[31,37]},{"type":{"label":"</>"},"value":">","range":[38,39]},{"type":{"label":"num"},"value":0,"range":[40,41]},{"type":{"label":")"},"range":[41,42]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
  t.is(json[1].props.className, className);
});

(0, _ava2.default)('merges with existing child classNames', function (t) {
  ...
  t.regex(_rec2._expr(_rec2._capt(className, 'arguments/0'), {
    content: 't.regex(className, /^beep\\s/)',
    filepath: 'test.js',
    line: 43,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"regex","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"className","range":[8,17]},{"type":"RegExpLiteral","pattern":"^beep\\\\s","flags":"","range":[19,28]}],"range":[0,29]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"regex","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"className","range":[8,17]},{"type":{"label":","},"range":[17,18]},{"type":{"label":"regexp"},"value":{"pattern":"^beep\\\\s","flags":""},"range":[19,28]},{"type":{"label":")"},"range":[28,29]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), /^beep\s/);
});
//# sourceMappingURL=/Users/bjackson/repos/grid-styled/styled-space/node_modules/.cache/ava/1eefc578e41ebf37e0ec1cfc976734e8.js.map